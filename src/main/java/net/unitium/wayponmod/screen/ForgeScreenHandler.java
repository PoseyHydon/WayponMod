...
import net.unitium.wayponmod.block.entity.ForgeBlockEntity;
...
public class ForgeScreenHandler extends ScreenHandler {
    ...
    public ForgeScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity, PropertyDelegate arrayPropertyDelegate) {
        ...
        this.addSlot(new Slot(inventory, 0, 31, 52));
        this.addSlot(new Slot(inventory, 1, 31, 25));
        this.addSlot(new Slot(inventory, 2, 56, 38));
        this.addSlot(new Slot(inventory, 3, 128, 38));
